...
export function AIAssistantInterface() {
  ...
  return (
    <div className="py-24 bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30 relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-6">
        ...
        <div className="w-full max-w-3xl mx-auto flex flex-col items-center">
          ...
          <div className="mb-10 text-center">
            ...
            >
              <h3 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400 mb-2">
                Ready to assist you
              </h3>
          ...
          <div className="w-full bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden mb-4">
            ...
            <div className="px-4 py-3 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button className="p-2 text-gray-400 hover:text-gray-600 transition-colors" data-testid="button-microphone">
